...
class TestCourseFilter(unittest.TestCase):
    ...
    # # Mock input
    #@ path intercepts the user input and automatically returns a desired value
    ...
    # runs tests inside out soo builtins.input runs first, the builtins.print runs second
